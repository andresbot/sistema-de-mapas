...
```javascript
{
  ...
  nombre: String,
  descripcion: String,
  categoria: ObjectId,   // Referencia a Category
  ubicacion: {
    type: "Point",
  ...
  creador: ObjectId,     // Referencia a User
...
{
  _id: ObjectId,
  lugar: ObjectId,       // Referencia a Place
  usuario: ObjectId,     // Referencia a User
  puntuacion: Number,    // 1-5 estrellas
  comentario: String,
  imagenes: [String],    // Fotos del usuario
  fechaVisita: Date,
...
| **MongoDB** | Base de Datos | Flexible (NoSQL), fácil de escalar, JSON nativo |
| **Mongoose** | ODM | Validación, schemas, queries simplificadas |
